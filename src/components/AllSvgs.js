  ...
  return (    
    <svg 
      ...
      xmlns="http://www.w3.org/2000/svg" >
        ...
        <g>
          <circle clip-rule="evenodd" cx="16" cy="16" fill={props.fill} fill-rule="evenodd" r="16"/>
        <g>
          <rect fill="#cad0d7" height="14" width="4" x="7" y="11"/>
          <path d="M20.499,11c-2.791,0-3.271,1.018-3.499,2v-2h-4v14h4v-8c0-1.297,0.703-2,2-2c1.266,0,2,0.688,2,2v8h4v-7    C25,14,24.479,11,20.499,11z" fill="#cad0d7"/>
          <circle cx="9" cy="8" fill="#cad0d7" r="2"/>
        </g>
        </g>
      </svg>
  )
